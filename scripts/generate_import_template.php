...
$instructions = [
    ...
    '• cedula_escolar: Formato V-12345678, E-12345678 o sólo números. (Opcional — dejar vacío si no tiene)',
    '• fecha_nacimiento: Usar formato DD/MM/YYYY o YYYY-MM-DD. Ej: 15/08/2010. (Opcional)',
    '• genero: Usar M para Masculino o F para Femenino. (Obligatorio)',
    '• grado: Nombre del año escolar. Ej: 1er Año, 2do Año, 3er Año. (Opcional)',
    '• seccion: Letra de la sección. Ej: A, B. (Opcional — inscribe automáticamente en el año activo si se incluye grado)',
