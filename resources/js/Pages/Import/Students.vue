<template>
    <AppLayout title="Importar Estudiantes">
        <div class="max-w-4xl mx-auto space-y-8">
            ...
            <!-- Flash success -->
            <div v-if="$page.props.flash?.success" class="p-5 rounded-2xl bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 flex items-start gap-4 shadow-sm animate-fade-in-up">
                ...
                <div>
                    <p class="font-semibold text-emerald-800 text-sm">Archivo recibido</p>
            ...
            <div class="glass-card rounded-2xl p-6 border border-indigo-100/50">
                ...
                <p class="mt-3 text-xs text-slate-400 flex items-center gap-1.5">
                    ...
                    Si una cédula ya existe en el sistema, esa fila será omitida automáticamente.
                ...
                <form @submit.prevent="submit" enctype="multipart/form-data">
                    ...
                    <div class="mt-5 p-4 rounded-xl bg-blue-50 border border-blue-200 flex items-start gap-3">
                        ...
                        <div class="text-xs text-blue-700">
                            ...
                            un resumen con la cantidad de estudiantes registrados y filas omitidas.
                        </div>
                    </div>
